...
export function WeeklyLevelCard({ progress }: { progress: Progress }) {
  return (
    <section className="rounded-lg border border-slate-700 bg-gradient-to-r from-sky-900/40 to-violet-900/30 p-5">
      ...
      <p className="mt-1 text-sm text-slate-300">
        {progress.progressPercentage}% weekly target progress
      </p>
    </section>
  );
}
