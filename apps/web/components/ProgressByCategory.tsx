          ...
          {progress.progressByCategory.map((i, idx) => (
            ...
            >
              <div className="flex items-center justify-between">
                <span
                  className={`rounded px-2 py-0.5 text-xs border ${CATEGORY_STYLES[idx % CATEGORY_STYLES.length]}`}
                >
                  {i.categoryName}
                </span>
